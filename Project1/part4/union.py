...
FA1_json = open('C:\git\TheoryofLanguagesAndAutomata\Project1\TheoryofLanguagesAndAutomata\samples\phase4-sample\\union\in\FA1.json')
FA1 = json.load(FA1_json)

FA2_json = open('C:\git\TheoryofLanguagesAndAutomata\Project1\TheoryofLanguagesAndAutomata\samples\phase4-sample\\union\in\FA2.json')
